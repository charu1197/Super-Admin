...
<body>
  <div class="main-wrapper">
    ...
    <div class="page-wrapper">
                ...
                <table class="table table-striped custom-table datatable">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-right">
                        <a href="#" data-toggle="modal" name="id" data-target="#decline_password_request" data-id="" title="Decline" class="btn text-xs text-white btn-danger action-icon decline-password-btn">
      ...
      <!-- MODAL FOR CHANGE PASSWORD REQUEST -->
            ...
            <div class="modal-body">
              <form id="changePasswordForm">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="currentPassword" value="" name="currentPassword" readonly>
                </div>
                <div class="form-group">
